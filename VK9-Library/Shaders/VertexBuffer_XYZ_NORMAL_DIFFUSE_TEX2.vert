...
void main() 
{
	...
	{
		texcoord1 = (attr3 * shaderState.mTextureStages[0].textureTransformationMatrix).xy;
	}
	...
	{
		texcoord2 = (attr4 * shaderState.mTextureStages[1].textureTransformationMatrix).xy;
	}
