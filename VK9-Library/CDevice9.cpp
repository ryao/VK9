	...
	mBehaviorFlags(BehaviorFlags)
{
	...
	*/
	...
	CRenderTargetSurface9* ptr2 = new CRenderTargetSurface9(this, mPresentationParameters.BackBufferWidth, mPresentationParameters.BackBufferHeight, ConvertFormat(mFormat));
